...
$(document).ready(function(){
	...
	function donorPlots(donor, aidType, year){
		...
		// plot to 50 countries receiving aid from this donor
		...
		$("#totalDonorAid").text(total_aid.toFixed(2));
		...
		//update GDP widget
		$("#donorGDP").text(donorGDP);
		
		////update Percapita widget
		var donorPercapita = Percapitas.filter(recs => recs["Country.Code"] == donorCode )[0][year];
		$("#donorPercapta").text(parseFloat(donorPercapita).toFixed(2));
